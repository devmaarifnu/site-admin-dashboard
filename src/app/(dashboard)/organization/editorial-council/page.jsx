    ...
    <>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-neutral-900">Dewan Redaksi</h1>
            <p className="text-neutral-500 mt-1">Kelola data dewan redaksi</p>
          </div>
                ...
                {members.length === 0 ? (
                  ...
                  members.map((member) => (
                    <TableRow key={member.id}>
                      ...
                      <TableCell className="max-w-xs truncate">{member.expertise || '-'}</TableCell>
                      <TableCell>
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              onClick={() => router.push(`/organization/editorial-council/${member.id}/edit`)}
                            >
